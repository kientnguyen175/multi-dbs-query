...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'rdbms1' => [
            'driver' => 'mysql',
            'host' => env('FIRST_DB_HOST'),
            'port' => env('FIRST_DB_PORT'),
            'database' => env('FIRST_DB_DATABASE'),
            'username' => env('FIRST_DB_USERNAME'),
            'password' => env('FIRST_DB_PASSWORD'),
            'unix_socket' => env('FIRST_DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'strict' => true,
        ...
        'rdbms3' => [
            'driver' => 'mysql',
            'host' => env('THIRD_DB_HOST'),
            'port' => env('THIRD_DB_PORT'),
            'database' => env('THIRD_DB_DATABASE'),
            'username' => env('THIRD_DB_USERNAME'),
